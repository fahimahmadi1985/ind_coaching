...
for (let i = 0; i < products.length; i++){
    if (givenId === products[i].id) {
        console.log(products[i])
    }
}


/* find all odd and even numbers less than 25 */
for (let counter = 5; counter >= 0; counter--){
    if (counter % 2 === 0) {
        console.log(`${counter} is even number`)
    } else {
        console.log(`${counter} is odd number`)
    }
}
...
//print a message for a random number if it is bigger than 15 and less than 20
let rand;
while (!(15 < rand && rand < 20)) {
...
console.log(`result: ${sum(12, 14)}`);
console.log(`result: ${sum(5, 2)}`);
console.log(`result: ${sum(3, 6)}`);
console.log(`result: ${sum(5, 10)}`);
console.log(`result: ${sum(5, 10)}`);
